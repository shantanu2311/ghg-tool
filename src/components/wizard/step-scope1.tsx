  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 space-y-3">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        ...
        {/* Fuel Type */}
        <div className="space-y-1">
          <label className="block text-xs font-medium text-gray-600">Source / Fuel Type</label>
          <select
            className={selectClass}
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        <h2 className="text-base font-semibold text-gray-900">Scope 1 — Direct Emissions</h2>
      ...
      {loading && (
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm text-center">
          <p className="text-xs text-gray-400">Loading fuel options...</p>
        </div>
      )}
